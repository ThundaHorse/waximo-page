  ...
  return (
    <div>
      ...
      <Typography>
        ...
        collects, uses, discloses, and safeguards information from users (“you”
        or “your”) who visit our website, https://waximo.com, including all
        subdomains, directories, and linked content. By accessing or using our
        website, you agree to the terms of this Privacy Policy. If you do not
        agree, please do not use our site.
      </Typography>

      <Typography>
        This Privacy Policy is subject to applicable privacy laws, including the
        General Data Protection Regulation (GDPR), California Consumer Privacy
        Act (CCPA), the Personal Information Protection and Electronic Documents
      ...
      <Typography>
        ...
        you interact with our site: - Email Address: Collected when you
      ...
      <Typography>
        ...
        spent on the site - Referring and exit pages This information is used to
        analyze trends, administer the site, and gather demographic information.
        Analytics data is anonymous and does not directly identify individual
        users.
      </Typography>
      ...
      <Typography>
        ...
        our site, monitor traffic, and understand how users interact with the
      ...
      <Typography>
        ...
        Providing and maintaining our website’s functionality - Improving user
        experience through analytics and traffic monitoring - Sending
        newsletters, updates, or promotional emails** (only with your consent) -
        Ensuring website security and protecting against fraud - Compliance with
        legal obligations and to fulfill any contractual requirements We will
        not use your personal information for any purpose other than those
        listed in this policy unless we obtain your consent or are required by
        law.
      </Typography>
      <br />
      <Typography type='h4'>
      ...
      <br />
      <Typography>
        If you are located in the European Economic Area (EEA), our legal basis
        for collecting and using your personal information depends on the data
        we collect and the context in which we collect it. We may process your
        personal information because: - You have given us permission to do so
        (consent) - We need to perform a contract with you - Processing is in
        our legitimate interests and not overridden by your rights - We need to
        comply with the law.
      </Typography>
      <br />
      ...
      <ul>
        ...
        <li>
          Right to Erasure: Request deletion of your personal data under certain
          conditions.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          exercising any of your CCPA rights. To exercise your CCPA rights,
          please contact us at [Contact Email]. Note that we do not sell
      ...
      <ul>
        <li>
          **Right to Access:** Request access to your personal information that
          we hold and understand how it is being used or disclosed.
        </li>
        <li>
        ...
        <li>
          **Right to Withdraw Consent:** Withdraw your consent for us to
          collect, use, or disclose your personal information, subject to legal
          or contractual restrictions.
        </li>
      </ul>

      <Typography>
        To exercise your PIPEDA rights, please contact us at [Contact Email]. We
        will respond to your request in compliance with PIPEDA and Canadian
        privacy laws.
      </Typography>
      ...
      <Typography type='h4'>
        ...
        or electronic storage is 100% secure. We strive to use commercially
        acceptable means to protect your data but cannot guarantee absolute
        security. We retain personal information for as long as necessary to
        fulfill the purposes outlined in this Privacy Policy or comply with
        legal obligations. Once information is no longer needed, we securely
      ...
      <ul>
        ...
        <li>
          **In business transfers:** In the event of a merger, acquisition, or
          sale of all or a portion of our assets We do not sell, trade, or rent
      ...
      <Typography type='h4'>
        ...
        Google Analytics and other analytics tools to deliver tailored
        experiences on our website. However, we do not make any decisions solely
        based on automated processing that would produce legal effects or
        similarly significant effects. If applicable, users may have the right
        to object to automated decision-making and profiling by contacting us at
      ...
      <Typography type='h4'>
        ...
        laws may differ. We ensure that such transfers are conducted in
        compliance with applicable data protection laws and implement adequate
      ...
      <Typography type='h4'>
        ...
        of these third-party sites. We encourage you to read their privacy
      ...
      <Typography type='h4'>
        ...
        required by applicable laws. Notifications will be provided in a timely
        manner and will include information about the nature of the breach, the
      ...
      <Typography type='h4'>
        ...
        and with your consent. If you inadvertently or intentionally provide
        sensitive personal information, you consent to our processing of that
      ...
      <Typography type='h4'>
        ...
        from children. If we become aware of any such data being collected, we
      ...
      <Typography type='h4'>
        ...
        new policy on this page. Your continued use of the website after the
        effective date constitutes your acceptance of the revised Privacy
        Policy.
      </Typography>
      <br />
      <Typography type='h4'>
  ...
  return (
    <>
      ...
      <Typography>
        ...
        manner to meet the Client’s needs regarding the provision of the
      ...
      <ul>
        ...
        <li>
          Avoid spamming, trolling, or posting repetitive or irrelevant content.
        </li>
        <li>
      ...
      <Typography>
        ...
        from your website. No link(s) should appear on any website that could be
      ...
      <Typography>
        ...
        expenses associated with the arbitration unless otherwise determined by
        the arbitrator.
      </Typography>
      <br />
      <Typography>
        Either party may seek temporary or preliminary injunctive relief from a
        court of competent jurisdiction if necessary to protect their rights or
